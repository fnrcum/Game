...
from constants import (SCREEN_WIDTH, SCREEN_HEIGHT, TILE_SIZE, LIMIT_FPS, WINDOW_COLOR)
...
class Manager(object):
    ...
    def __init__(
            ...
            limit_fps=None, window_color=None, flags=sdl2.SDL_WINDOW_BORDERLESS
    ):
        """Initialization.
